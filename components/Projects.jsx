...
const Projects = () => {
    ...
    return (
        <div className='lg:w-[70%] h-[100vh] md:w-[100%] w-[100%] absolute lg:top-0 right-0 p-4 md:p-4 lg:p-0 top-[85px] md:overflow-scroll'>
                ...
                <div className="w-auto h-auto mt-7">
                    <div className="text-[#9F9F9F] flex gap-9">
                        {buttons.map((item, index) => (
                            <button
                                key={index}
                                className={`transition-colors duration-200 ${isSelected === index ? "text-[#FDC763]" : "text-[#A2A2A2]"}`}
