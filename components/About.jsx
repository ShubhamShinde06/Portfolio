        ...
        <div className='mt-9'>
          ...
          <div className="flex flex-col items-center justify-center mt-5">
            <div className=" grid mx-auto grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-[10px]">
              ...
              <div className='hover:border-[#FFC663] lg:h-[150px] h-[170px] bg-[#212123] border-2 border-[#343434] lg:flex lg:items-center p-4 rounded-2xl'>
                ...
                <div className='lg:mt-3 ml-5 break-all'>
                  <h1 className='mb-3 font-bold md:text-[20px] text-center mt-2 lg:mt-0 lg:text-left'> Web Development</h1>
                  <p className='text-[#D3D3D3] text-center lg:text-left'>High-quality development of sites at the professional level.</p>
                </div>
              </div>

              <div className='hover:border-[#FFC663] lg:h-[150px] h-[170px] bg-[#212123] border-2 border-[#343434] lg:flex lg:items-center lg:p-5 p-4 rounded-2xl'>
                <div className='icon  w-[100%] lg:w-[100px] h-[auto] flex items-center justify-center text-[40px] text-[#FFC663] '>
                  <FaWordpressSimple/>
                </div>
